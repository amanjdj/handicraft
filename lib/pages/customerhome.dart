...
class _CustomerHomeState extends State<CustomerHome> {
    ...
    return Column(
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              dataList.length==0? Center(child: Text("No Post")):ListView.builder(itemCount: dataList.length,
                  itemBuilder:(_,index){
  ...
  Widget FeaturedProductss(String imageUrl, String title, String price) {
    Size size = MediaQuery.of(context).size;
